...
class AlignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        base_path_json = base_path.replace(".png","")
        pose_path = os.path.join('/kaggle/input/openposejson/openpose_json',base_path_json) + '_keypoints.json' # Modified line to meet kaggle requirements [OSError]
